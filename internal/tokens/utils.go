...
func parseTokenId(tokenId string) (tokenTypeId, assetDataId string, err error) {
	...
	if len(ids) != 2 {
		return "", "", NewErrInvalid("invalid tokenId")
	}
