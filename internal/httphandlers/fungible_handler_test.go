...
func TestHandler_FungibleDescribe(t *testing.T) {
	typeId := "aAbBcCdDeEfFgG"
	reqUrl := buildTestUrl(constants.FungibleDescribe.ForResource(typeId))
...
func TestHandler_FungibleMint(t *testing.T) {
	typeId := "aAbBcCdDeEfFgG"
	reqUrl := buildTestUrl(constants.FungibleMint.ForResource(typeId))
	method := http.MethodPost
...
func TestHandler_FungibleTransfer(t *testing.T) {
	typeId := "aAbBcCdDeEfFgG"
	reqUrl := buildTestUrl(constants.FungibleTransfer.ForResource(typeId))
	method := http.MethodPost
...
func TestHandler_FungibleConsolidate(t *testing.T) {
	typeId := "aAbBcCdDeEfFgG"
	reqUrl := buildTestUrl(constants.FungibleConsolidate.ForResource(typeId))
	method := http.MethodPost
...
func TestHandler_FungibleAccounts(t *testing.T) {
	...
	owner := "user1"
	account := "acc1"
	path := constants.FungibleAccounts.ForResource(typeId)
